...
<svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"  {{ $attributes->class($size_class) }}>
    ...
    @elseif($icon === 'cog-6-tooth' || $icon === 'cog')
    ...
    @elseif($icon === 'document-duplicate')
    ...
    @elseif($icon === 'error')        
        ...
        <path d="M15 9L9 15M9 9l6 6" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/>
    @elseif($icon === 'eye')
    ...
    @elseif($icon === 'warning')
        <path d="M10.29 3.86L1.82 18a1.75 1.75 0 0 0 1.51 2.64h16.34a1.75 1.75 0 0 0 1.51-2.64L13.71 3.86a1.75 1.75 0 0 0-3.42 0z" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
        <line x1="12" y1="9" x2="12" y2="13.5" stroke-width="1.6" stroke-linecap="round"/>
        <line x1="12" y1="16.2" x2="12.01" y2="16.2" stroke-width="1.8" stroke-linecap="round"/>
    @elseif($icon === 'wrench')
    ...
    @else       
        {{ throw new \Exception("No such svg {$icon}") }}
    @endif
</svg>